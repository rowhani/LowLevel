Title Artman SINH Calculator - Normal_Precision_Graphical
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
main proc near
	...
	mov ds,ax
		...
		MOV AH,03	;READ CURSOR
		MOV BH,0
		INT 10H
		
		mov ah,13h	;output string
		mov bl,29h	;attribute and color
		mov bh,0	;page
		mov al,1	;string with attrubute in bl and curor update
		mov si, dataseg
		mov es,si		
		mov bp, offset welcomemsg		
		mov cx,40	;number of chars
